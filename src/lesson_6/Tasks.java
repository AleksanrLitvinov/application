...
//
        ...
        String pathBeforeDog = split[0];
        String pathAfterDog = split[1];

        if (pathAfterDog.startsWith(".") || pathAfterDog.endsWith(".")){
            System.out.println("Your email not correct");
            return;
        }

        if (pathBeforeDog.startsWith(".") || pathBeforeDog.endsWith(".")) {
            System.out.println("Your email not correct");
            return;
        }

        System.out.println("User email is correct");
